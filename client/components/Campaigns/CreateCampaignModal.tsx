...
export function CreateCampaignModal({
  ...
  return (
    <Modal open={open} title="Create campaign" onClose={onClose}>
      <form
        className="space-y-4"
      ...
      >
        ...
        <Select
          ...
          {...register("caller_agent_id", { required: "Caller agent is required" })}
        >
        ...
        <Input
          ...
          {...register("scheduled_at", { required: "Schedule is required" })}
        />
        ...
        <div className="grid grid-cols-2 gap-3">
          <Input
            ...
            min={1}
            max={10}
            {...register("retry_attempts", { valueAsNumber: true, min: 1, max: 10 })}
          />
          <Select label="Retry interval" {...register("retry_interval")}>
        ...
        <FormActions
          onCancel={onClose}
          submitLabel={loading ? "Creating..." : "Create campaign"}
          loading={loading}
        />
      </form>
    </Modal>
