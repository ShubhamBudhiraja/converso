        ...
        try {
            ...
            setFormError(
                err instanceof ApiError
                    ? err.message
                    : "Failed to register with ElevenLabs",
            );
        }
    }
            ...
            <div className="space-y-4">
                ...
                {connectionsLoading ? (
                    <p className="text-sm text-zinc-500">
                        Loading ElevenLabs accounts...
                    </p>
                ) : connections.length === 0 ? (
                    <p className="text-sm text-zinc-500">
                        No ElevenLabs accounts connected. Add one under AI
                        Providers first.
                    </p>
                ) : (
                    <Select
                ...
                <p className="text-xs text-zinc-500">
                    This imports the Twilio number into ElevenLabs using your
                    saved Twilio credentials so it can be used with
