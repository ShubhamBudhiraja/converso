    ...
    return (
        <div className="rounded-xl border border-zinc-200 p-5 dark:border-zinc-800">
            ...
            <dl className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    <dt className="text-xs text-zinc-500">Account SID</dt>
                    <dd className="mt-1 font-mono text-sm text-zinc-900 dark:text-zinc-50">
                        {connection.account_sid_masked}
                    </dd>
                </div>
                <div>
                    <dt className="text-xs text-zinc-500">Auth token</dt>
                    <dd className="mt-1 font-mono text-sm text-zinc-900 dark:text-zinc-50">
                        {connection.auth_token_masked}
                    </dd>
                </div>
                <div>
                ...
                <div>
                    <dt className="text-xs text-zinc-500">Phone numbers</dt>
                    <dd className="mt-1 text-sm font-medium text-zinc-900 dark:text-zinc-50">
