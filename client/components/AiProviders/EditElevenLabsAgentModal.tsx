...
import { ApiError, ElevenLabsAgent, ElevenLabsVoice, aiProviderApi } from "@/lib/api";
  ...
  useEffect(() => {
    ...
    aiProviderApi
      ...
      .then((detail) => {
        reset({
          name: detail.name,
          system_prompt: detail.system_prompt || "You are a helpful assistant.",
          first_message: detail.first_message || "Hello! How can I help you today?",
          voice_id: detail.voice_id || "",
          llm: detail.llm || "gpt-4o-mini",
        });
      })
      .catch((err) => {
        setFormError(err instanceof ApiError ? err.message : "Failed to load agent details");
      })
